...
namespace OperatorsExpressionsStatements
{
    class OESPart8
    {
        static void Main(string[] args)
        {
            ...
            // There are many opertors used to evaluate values ...
            ...
            // There are two "conditiona" operators as well that can be used to expand / enhance an evaluation
